...
INSERT INTO cars(id, make, model, price, month, year, engine_id, category_id, gear_box_id, mileage, color_id, safety_id, exterior_id, interior_id, protection_id,  comfort_id, other_id, additional_information, date_added)
VALUES(1, "Volkswagen", "Tiguan", "16400", "June", "2010", 1, 4, 2, "245000", 1, 1, 1, 1, 1, 1, 1, "New importation . . SWITZERLAND. . . 4x4. . . . Navigation. . . . Service book. . . Very good technical and visual condition. . . . Solid undercarriage - Preserved Interior - Motor and Box work perfectly. . . Very Strong and Practical Jeep. . . All systems and units are 100% functional. The car was bought directly from the owner, uniquely preserved. The car is sold with an invoice and a contract from the company, at any time convenient for you. I assist in the extraction of transit insurance numbers. ALL VEHICLES IN THE DEALERSHIP HAVE CATALYTIC DEVICES AVAILABLE. ! !", NOW());
